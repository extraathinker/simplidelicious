...
<div class="container-fluid mb-3">
    <div class="container">
        ...
        <form class="form-group p-4 bg-warning-subtle" style="max-width:700px; margin:auto;" method="post" action="{{url('/')}}/waitforapproval" enctype="multipart/form-data">
            @csrf
            ...
            <x-inputform label="Ingredients :" name="ingredients" type="text"/>
            <span class="text-danger">
                @error('ingredients')
                    {{$message}}.<br>
                @enderror
